...
std::vector<std::filesystem::path> find_files(const std::filesystem::path& par_path, std::function<bool(const std::filesystem::path par_path)> par_filter, bool par_recursive = false) {
