...
inline void IK_UI::cb_Fixed_i(fltk::Item*, void*) { JointType(IKJT_Fixed); }
void IK_UI::cb_Fixed(fltk::Item* o, void* v) {
  ((IK_UI*)(o->parent()->parent()->user_data()))->cb_Fixed_i(o, v);
}

inline void IK_UI::cb_Hinge_i(fltk::Item*, void*) { JointType(IKJT_Hinge); }
void IK_UI::cb_Hinge(fltk::Item* o, void* v) {
  ((IK_UI*)(o->parent()->parent()->user_data()))->cb_Hinge_i(o, v);
}

inline void IK_UI::cb_Universal_i(fltk::Item*, void*) { JointType(IKJT_Universal); }
